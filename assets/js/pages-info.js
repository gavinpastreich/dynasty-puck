  ...
  DP.pages.rules = {
    ...
    render: function (el) {
      ...
      h += '<div class="grid g2"><div class="card"><h2>League rules (as modeled)</h2><ul>' +
        ...
        '<li>Schedule: the real 2026-27 Fantrax H2H schedule, 24 regular-season periods (period 19 spans Feb 1–14). <b>Playoffs: 8 teams, no byes</b>: 1v8, 4v5, 3v6, 2v7 (Mar 22–28), then winners meet (Mar 29–Apr 4), final Apr 5–10. A tied playoff matchup goes to the higher seed (assumption).</li>' +
        ...
        '<li><b>Auction (UFA bidding):</b> the winning bid sets the term. 2026 and 2027 offseasons ($104M bands): $1.0-2.9M 1 yr · $3.0-4.4M 2 · $4.5-7.4M 3 · $7.5-9.9M 4 · $10.0-13.9M 5 · $14.0M+ 6. 2025 initial auction ($95.5M): $1-2.49M 1 · $2.5-3.99M 2 · $4-6.49M 3 · $6.5-8.99M 4 · $9-12.5M 5 · $12.5M+ 6. Later auctions: bands assumed to scale with the cap (not a league rule yet).</li>' +
        ...
        '<li><b>Initial-auction RFAs</b> (2025 BID deals and the 2026 RFA1 deals signed off them) are priced with the contract sheet formula (S = salary): 1yr S+1.5, 2yr 1.5S+1.5, 3yr 1.5S+3, 4yr 1.5S+4, 5yr 1.75S+5, 6yr 1.75S+6 (2026 used +1.0 bases). The model assumes the same formula at later expiries.</li>' +
        ...
        '<li><b>Dead cap:</b> dropped contracts retain 50% of salary (commissioner). Modeled as 50% of every remaining contract season.</li>' +
