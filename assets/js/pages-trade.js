...
(function () {
  ...
  DP.pages.history = {
    ...
    render: function (el, hsh) {
      ...
      h += '<div class="card" style="margin-top:14px"><h2>🧠 GM trade personas</h2><div class="hint">How each GM has traded so far: picks, age, cap and win-now value moving in and out.</div>' + (DP.personasHtml ? DP.personasHtml() : '') + '</div>';
